...
public class BoardController extends HttpServlet {
	...
	private static String ARTICLE_IMAGE = "C:\\workspace-sts\\webstore_image"; //업로드한 이미지 파일 저장위치
	...
	private void doAction(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			if(action == null) {
			...
			else if (action.equals("/viewActicle.do")) {
				...
				pWriter.print("<script>" + " alert('글을 수정했습니다.'); "
						+ " location.href='"+request.getContextPath()+"/board/viewActicle.do?articleNo="+articleNo+"';"
						+ "</script>");
				return;
				...
				//업로드 완료시 팝업 생성
				PrintWriter pWriter = response.getWriter();
				pWriter.print("<script>" + " alert('새글이 추가되었습니다!');" + " location.href='" +request.getContextPath()+ "/board/viewActicle.do?articleNo="+articleNo+"';" + "</script>");
				return;
